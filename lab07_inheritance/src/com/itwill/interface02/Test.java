 ...
 * 5. private static 메서드 - Java 9 버전부터 (private static 생략 불가능.)
 *    -> body가 구현된 메서드.
...
public interface Test {
	...
	// 3. [public] static 메서드
	static void staticMethod() { // 객체 없이 타입 이름을 붙여서 호출 가능.
	...
	default void defaultMethod() { // 인스턴스가 존재해야 사용할 수 있는 메서드.
