...
public class InheritanceMain06 {
	...
	public static void main(String[] args) {
		...
		Point p1 = new Point();
		System.out.println(p1); // p1.toString()과 출력 결과 같음.
		
		
		
		// 아규먼트를 갖는 생성자를 사용해서 Point 타입 객체 생성
		Point p2 = new Point(0,0);
		System.out.println(p2); // p2.toString()과 출력 결과 같음.
		
		System.out.println("비교 연산자 결과: " + (p1 == p2)); // 주소값 비교
		System.out.println("equals() 메서드 결과: " + p1.equals(p2));
		// 객체의 동등비교에서는 비교 연산자(==, !=)를 사용하면 안된다!
