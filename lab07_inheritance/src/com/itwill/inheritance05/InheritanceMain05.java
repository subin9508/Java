 ...
 *   0. Object 클래스는 객체의 주소값으로 해시코드를 만듦.
 *   0. 해시코드가 만족해야 하는 조건
 *   	1. 같은 객체에서 hashCode()를 여러번 호출하더라도 항상 같은 정수가 리턴되어야 함. (난수 불가능. 결과가 예측 가능해야함.)
 *   	2. equals() 메서드의 결과가 true가 되는 두 객체의 해시코드 값은 같아야 함.
 *   		equals()가 true이면  hashCode()도 true가 되어야 함. 
...
public class InheritanceMain05 {
	...
	public static void main(String[] args) {
		...
		// 아규먼트가 null이 아닌 경우에는 x.String()이 리턴하는 문자열을 콘솔에 출력.
