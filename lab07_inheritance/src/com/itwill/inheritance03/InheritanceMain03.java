...
public class InheritanceMain03 {
	...
	public static void main(String[] args) {
		...
		// SuperType var = new Sub Type();
		Car car3 = new HybridCar(50, 40, 100);
		car3.drive(); //-> 다형성으로 선언되어 있더라도, override 되어 있는 메서드가 호출된다!
		// car3.charge(100); // -> casting을 하지 않으면, SubType의 모든 메서드를 사용할 수는 없다.
		((HybridCar) car3).charge(100); // casting을 하면, SubType의 모든 메서드를 사용할 수 있다.
		
		
		
		// SubType var = new SuperType(); -> 컴파일 오류
		// HybridCar var = new Car(100, 100); (x)
