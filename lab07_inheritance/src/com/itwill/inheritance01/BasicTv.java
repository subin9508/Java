...
public class BasicTv {
	...
	//getters and setters
	public boolean isPowerOn() { // boolean을 리턴하는 메서드들 중에서 is로 형성되어있는 것이 관습.
		return powerOn;
	}
	...
	// 메서드
	/**
	 * TV가 켜져있으면 끄고, TV가 꺼져있으면 켬.
	 * powerOn의 값이 true이면 false 변경, powerOff의 값이 false이면 true로 변경.
	 * @return powerOn의 값
	 */
	 ...
	 * 만약 현재 음량 값이 음량의 최댓값(MAX_VOLUME)인 경우, 음량의 최솟값(MIN_VOLUME)으로 변경.
	 * @return 바뀐 현재 음량 값.
	 */
	public int volumeUp() { // TV가 켜져 있을 때만
