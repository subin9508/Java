 ...
 * - 자바 언어는 클래스 안에서만 함수를 작성할 수 있음 -> 자바는 메서드만 작성할 수 있다. (자바는 클래스를 벗어나서 작성할 수 없음.)
 * 
 * argument(아규먼트, 인수, 인자): 메서드를 호출하는 곳에서 메서드에게 전달하는 "값".
...
public class MethodMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println("안녕하세요."); // 가장 마지막에 위치한 것이 메서드 이름.
		//-> println 메서드를 호출. 
		//-> println을 호출할 때 전달한 값("안녕하세요.")을 argument.
		//-> println 메서드에서 아규먼트를 저장하기 위해 선언한 변수. -> parameter
