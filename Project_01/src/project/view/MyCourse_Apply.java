...
public class MyCourse_Apply extends JPanel implements ActionListener, AncestorListener {
	...
	private JLabel courseNumberT, courseTitleT, teacherT, classroomT;
	...
	public MyCourse_Apply(String id, MyCourse_Me mcm) {
		...
		classroomT = new JLabel();
		classroomT.setFont(new Font("굴림", Font.PLAIN, 20));
		...
		courseNumberT.setBounds(201, 354, 224, 20);
		
		courseTitleLabel.setBounds(96, 394, 77, 24);
		courseTitleT.setBounds(172, 398, 224, 20);
		
		teacherLabel.setBounds(96, 437, 77, 24);
		teacherT.setBounds(172, 437, 224, 20);
		
		classroomLabel.setBounds(96, 478, 77, 24);
		classroomT.setBounds(172, 479, 224, 20);
	...
	private void applyCourse() {
		String id = this.id;
		String name = myName;
		String courseTitle = teacherT.getText();
