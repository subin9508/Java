...
public class VariableMain01 {
	...
	public static void main(String[] args) {
		...
		// 변수를 사용할 때에는 
		// (1) 변수 선언: 저장하는 데이터의 종류(타입)과 변수 이름을 선언하는 것을 의미.
		// (2) 변수 초기화(initialize): 변수에 값을 처음 저장하는 것을 의미.
		int age; // 정수(integer)를 저장하는 변수 age
		age = 16; // 변수 age를 16으로 초기화(변수 age에 정수 16을 저장)
		
		System.out.println("나이: " + age);
		
		int x = 100; // 변수를 선언과 동시에 초기화. (변수 선언과 초기화를 한 문장으로 작성) (100을 x로 초기화한다는 의미)
		System.out.println("x = " + x);
		
		// 자바(Java)의 기본 데이터 타입 (자바의 키워드)
		// 정수 타입: byte, short, int, long, char
		// 실수 타입: float, double
		// 논리 타입: boolean
		long number = 12_345_678_900L; // L: long의 의미. (붙이지 않으면 에러 발생)
		double pi = 3.141592;
		boolean isMarried = false; // true 
		
		// 변수 이름 작성 규칙:
		// - 변수 이름은 알파벳, 숫자, _, $만 사용 가능.
		// - 변수 이름은 대/소문자를 구분함. (예) x와 X는 서로 다른 변수.
		// - 변수 이름은 숫자로 시작할 수 없음.
		// - 변수 이름으로 자바의 키워드(예약어)는 사용할 수 없음. > 여기까지는 필수 규칙
