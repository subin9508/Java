 ...
 * 2. 값들을 저장할 때마다 인덱스는 자동으로 증가함. (저장공간을 늘릴 필요 없음) (인덱스는 0부터 시작)
 * 3. 리스트 중간에 있는 값을 삭제하면 인덱스가 자동으로 재배열 된다.
...
public class ListMain01 {
	...
	public static void main(String[] args) {
		...
		// 지우려는 인덱스의 원소 값 자체를 지울 때 쓰는 코드. (객체를 찾아 지워줌)
