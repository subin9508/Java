 ...
 * 	- 현재 폴더(디렉토리)를 나타낼 때는  .을 쓴다. (예) .\data\hello.txt
 * 	- 상위 폴더(디렉토리)는 ..을 쓴다. (예) ..\src\com\itwill\file08\FileMain.java
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		// 이클립스에서 자바 프로그램이 실행되는 현재 작업 디렉토리(CMD)
		String cwd = System.getProperty("user.dir" );
		System.out.println("CWD: " + cwd);
		
		String path = "C:\\Users\\itwill\\git\\subin\\lab12_file"; // Windows 절대 경로 표현법 
		System.out.println(path);
		// String path2 = "data\\hello.txt." // Windows 상대 경로 표헌법
		String path2 = "data" + File.separator + "hello.txt"; // os에 무관한 상대 경로
		System.out.println(path2);
				
		// File 클래스: 
		// 파일 (txt, jpg, mp4, ....)과 폴더(디렉토리)에 관련된 기능성을 클래스
...
//        System.out.println(testFolder.getAbsolutePath());
        ...
        if(testFolder.exists()) {
        	...
        	testFolder.mkdir(); // make directory : 새 폴더를 만들어준다.
