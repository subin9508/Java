...
public class ArrayMain01 {
	...
	public static void main(String[] args) {
		...
		// -> 정수 타입 기본값(0), 실수 타입 기본값(0.0), boolean 타입 기본값(false), 그 이외의 타입들의 기본값(null)
		// [...] 타입을 저장하는 배열입니다 의 의미
		int[] scores = new int[3]; // int 타입 3개를 저장할 수 있는 배열. 모든 값은 0으로 초기화.
		// new int의 괄호 안의 숫자는 원소 개수를 의미.
		...
		System.out.println("length = "+ scores.length); // : 배열 타입에서만 length 사용가능.
